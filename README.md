...
### Prerequisites
- Install a version of [Python from 3.9 or later](https://www.python.org/downloads/). 
...
* Step 1: Open a console and navigate to the folder containing this README.md document.
    * Run `uv sync` to install the required packages and create a virtual environment. (Azure AI Speech Toolkit: Build the Sample App will be installed automatically, or you can install it manually.)
    ...
    * Run `uv run python -m flask run -h 0.0.0.0 -p 5000` to start this sample. (Azure AI Speech Toolkit: Run the Sample App will run automatically, or you can run it manually.)
